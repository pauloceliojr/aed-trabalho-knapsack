...
class TabuSearchKnapsack:
    ...
    def _busca_tabu(self, solucao_inicial, iteracoes=100):
    ...
    def solucionar(self):
        greedy_knapsack = GreedyKnapsack(valor_disponivel, self.itens)
...
if __name__ == "__main__":
    ...
    print(f"Importância máxima que obtemos = {itens1.importancia_atualizada.sum()}")
    itens1["valor_atualizado"] = itens1.valor * itens1.proporcao
    print(f"Valor máximo que obtemos = {itens1.valor_atualizado.sum()}")
